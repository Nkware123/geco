...
class users extends BaseController
{
  ...
  public function liste()
  {
    ...
    $query = $db->query("SELECT * FROM users join agence lieu ON lieu.ID_AGENCE=users.ID_AGENCE join fonction_poste fonction ON fonction.ID_FONCTION=users.ID_FONCTION");
  ...
  public function save_user()
  {
    ...
    $datacolumsinsert = array('NOM_USER' => $NOM_USER,'PRENOM_USER'=>$PRENOM_USER,'USERNAME'=>$USERNAME,'PASSWORD'=>$PASSWORD,'TELEPHONE'=>$TELEPHONE,'ID_FONCTION'=>$ID_FONCTION,'ID_AGENCE'=>$ID_LIEU_AFFECTATION,'PHOTO_PROFIL'=>$PHOTO_PROFIL);
  ...
  public function update_user()
  {
    ...
    $data = array('NOM_USER' => $NOM_USER,'PRENOM_USER'=>$PRENOM_USER,'USERNAME'=>$USERNAME,'PASSWORD'=>$PASSWORD,'TELEPHONE'=>$TELEPHONE,'ID_FONCTION'=>$ID_FONCTION,'ID_AGENCE'=>$ID_LIEU_AFFECTATION,'PHOTO_PROFIL'=>$PHOTO_PROFIL);
